  ...
  <div id="puppeteer-recorder" class="recorder">
    ...
    <div class="main">
      <div class="tabs" v-show="!showHelp">
        ...
        <ResultsTab :code="code" :copy-link-text="copyLinkText" :restart="restart" :set-copying="setCopying" @update='updateCode' v-if="showResultsTab"/>
  ...
  methods: {
    ...
    stop() {
      ...
      this.$chrome.storage.local.get(['recording', 'options'], ({ recording, options }) => {
        ...
        const codeGen = new CodeGenerator({ ...codeOptions, testTitle: this.title || 'test_name_default' });
